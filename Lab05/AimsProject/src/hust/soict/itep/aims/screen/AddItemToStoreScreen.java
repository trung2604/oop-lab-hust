...
import hust.soict.itep.aims.screen.SpringUtilities;
...
//		                                6, 6);       //xPad, yPad
	...
	public static void main(String[] args) {
		...
		DigitalVideoDisc dvd1 = new DigitalVideoDisc(1, "The Lion King",
				"Animation", 19.95f, 87, "Roger Aller");
		...
		DigitalVideoDisc dvd4 = new DigitalVideoDisc(4, "The Lion King",
		"Animation", 19.95f, 87, "Roger Aller");
		System.out.println(dvd4.getId());
		store.addMedia(dvd4);
		
		DigitalVideoDisc dvd5 = new DigitalVideoDisc(5, "Star Wars",
		"Science Fiction", 24.95f, 87, "George Lucas");
		System.out.println(dvd5.getId());
		store.addMedia(dvd5);
		
		DigitalVideoDisc dvd6 = new DigitalVideoDisc(6, "Aladin",
		"Animation", 18.99f);
		System.out.println(dvd6.getId());
		store.addMedia(dvd6);
		
		DigitalVideoDisc dvd7 = new DigitalVideoDisc(7, "The Lion King",
		"Animation", 19.95f, 87, "Roger Aller");
		System.out.println(dvd7.getId());
		store.addMedia(dvd7);
		
		DigitalVideoDisc dvd8 = new DigitalVideoDisc(8, "Star Wars",
		"Science Fiction", 24.95f, 87, "George Lucas");
